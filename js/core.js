...
Tag.prototype.selector = function(){
    return this.tag+'#'+this.id;
};

Tag.prototype.query = function(){
...
ViewList.prototype.display = function(start, end){
    if(typeof start !== 'undefinde'){
        start = 0;
    }
    if(typeof end !== 'undefinde'){
        end = this.items.length;
    }
    var wrapper = this.frame.query();
...
ViewList.prototype.listen = function(){
    jQuery(document).on('click', this.item.selector(), function(){
